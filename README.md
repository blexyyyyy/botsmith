...
BotSmith is a modular, production-oriented multi-agent framework that converts natural language requests into planned, validated, governed, and executable workflows.
It is designed to demonstrate how autonomous agents can be built safely, with strong separation of concerns, deterministic execution, and full observability.
...
Natural Language Input
        ↓
NLP Interpreter (LLM + validation)
        ↓
Router Agent
        ↓
Planner Agent
...
NLP extracts intent
Router selects bot_creation_workflow
...
Most AI agent projects focus on prompting.
BotSmith focuses on systems design.
